package com.mber.javarush.task.task15.task1505;
...
public class Solution {
    ...
    public static class BodyPart implements LivingPart {
        ...
        public String toString() {
            String string = null;
            if (containsBones().equals("Yes")) string = name + " содержит кости";
            if (containsBones().equals("No")) string = name + " не содержит кости";
            return string;
        }
    }
