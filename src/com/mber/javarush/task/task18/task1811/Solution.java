package com.mber.javarush.task.task18.task1811;
...
/*
1. наследоваться от того же интерфейса, что и оригинал;
2. создать переменную класса типа этого интерфейса (это называется композиция)
3. в конструкторе ее инициализировать;
4. реализовать интерфейс, вызывая в методе аналогичный метод оригинала (это называется делегирование) с добавлением дополнительного функционала (суть обертки).
*/