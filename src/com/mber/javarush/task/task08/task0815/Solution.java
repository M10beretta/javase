package com.mber.javarush.task.task08.task0815;
...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(getCountTheSameFirstName(createMap(), "Михаил")); //1
        System.out.println(getCountTheSameLastName(createMap(), "Морозов")); //1
    }
}